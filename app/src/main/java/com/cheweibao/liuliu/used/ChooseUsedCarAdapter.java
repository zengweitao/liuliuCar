...
public class ChooseUsedCarAdapter extends BaseAdapter {

    private Context mContext;
    private List<CarModelInfo> mList;

    public ChooseUsedCarAdapter(Context mContext, List<CarModelInfo> mList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tv_car_name.setText(info.getCarTypeName());
        holder.tv_car_min_price.setText("车型价格" + info.getCarPrice() + "万");
