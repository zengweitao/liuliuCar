package com.cheweibao.liuliu.alipay.task;
...
import com.cheweibao.liuliu.alipay.util.OrderInfoUtil2_0;
import com.cheweibao.liuliu.alipay.util.SignUtils;
...
//    private String sign;
    ...
    public AlipayTask(Context context, int type, String sign) {
        mContext = context;
        mType = type;
//        this.sign = sign;
    }
    ...
    protected void onPostExecute(String result) {
        ...
        if (TextUtils.equals(resultStatus, "9000")) {
            Intent it = new Intent(MyConstants.PAYMENT_SUCCES);
