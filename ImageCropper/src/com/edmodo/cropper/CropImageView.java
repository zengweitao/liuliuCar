...
public class CropImageView extends FrameLayout {
    ...
    public void setImageBitmap(Bitmap bitmap, boolean isHori, boolean isPick){
    	mBitmap = bitmap;
    	if ((isHori) && (!isPick)){
    		flipHoriImage();
    	}
    ...
    public void flipHoriImage(){
      	...
      	Bitmap localBitmap = Bitmap.createBitmap(mBitmap, 0, 0, mBitmap.getWidth(), mBitmap.getHeight(), matrix, true);
      	mBitmap.recycle();
      	mBitmap = null;
      	mBitmap = localBitmap;
    }
    ...
    //move faceDetection position
    public void moveCropView(float initX,float initY,float x,float y){
    	
    	mCropOverlayView.onActionDown(initX, initY);
    	mCropOverlayView.onActionMove(x, y);
    	mCropOverlayView.onActionUp();
    }
